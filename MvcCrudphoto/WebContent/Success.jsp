...
<body>
	<form name="f">
		<table border="2" style="width: 100%;">
			...
			<tr>
				<td><input type="radio" name="rd" value=<%=stu.getId()%>>
				<td>id:-<%=stu.getId()%></td>
				<td>uname:-<%=stu.getUname()%></td>
				<td>pw:-:-<%=stu.getPw()%></td>
				<td><img src="image/<%=stu.getImagename()%>" height="100" width="100" > </td>
		...
		<center>
			<input type="button" value="delete" onclick="del()"> <input
				type="button" value="add" onclick="add()"> <input
				type="button" value="Edit" onclick="ed()">
		</center>
